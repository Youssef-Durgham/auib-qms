  ...
  return (
    <div className="min-h-screen flex flex-col items-center justify-center p-6 relative overflow-hidden">
      ...
      <div className="absolute inset-0 overflow-hidden pointer-events-none">
        ...
        <div className="absolute -bottom-40 -left-40 w-96 h-96 bg-[#D4A843]/12 rounded-full blur-3xl" />
      </div>

      <div className="relative z-10 text-center mb-14 animate-slide-up">
        <Image
          src="/auib-logo.png"
          alt="AUIB"
          width={180}
          ...
          style={{ height: 'auto' }}
        />
        <div className="text-xs md:text-sm text-gray-500 font-medium tracking-[0.3em] uppercase">
          Queue Management System
        </div>
        <div className="mt-4 w-24 h-0.5 bg-gradient-to-r from-transparent via-[#D4A843] to-transparent mx-auto" />
      </div>
      ...
      <div className="relative z-10 grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-5 w-full max-w-5xl">
        {[
          ...
          >
            ...
            <div className="text-xl font-semibold text-gray-800 group-hover:text-[#9C213F] transition-colors duration-300">{item.title}</div>
            <div className="text-sm text-gray-500 mt-2">{item.desc}</div>
          </Link>
        ))}
      </div>

      <div className="relative z-10 mt-14 text-center text-gray-500 text-sm animate-fade-in" style={{ animationDelay: '0.5s' }}>
